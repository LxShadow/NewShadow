...
export async function before(m, {conn, participants}) {
  ...
  if (chat.detect2 && m.messageStubType == 29) {
    let txt1 = `*ha sido ascendido un admin.*\n\n`;
  ...
  if (chat.detect2 && m.messageStubType == 30) {
    let txt2 = `*se ha degradado a miembro.*\n\n`;
  ...
  if (chat.detect2 && m.messageStubType == 27) {
    let txt3 = `*se ha unido un nuevo miembro.*\n\n`;
  ...
  if (chat.detect2 && m.messageStubType == 32) {
    ...
    let txt5 = `*se ha ${ax} un miembro del grupo.*\n\n`;
  ...
  if (chat.detect2 && m.messageStubType == 26) {
    ...
    let txt6 = `*se han modificado los ajustes del grupo.*\n\n`;
  ...
  if (chat.detect2 && m.messageStubType == 21) {
    let txt7 = `*se ha cambiado el nombre del grupo.*\n\n`;
